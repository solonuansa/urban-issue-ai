      ...
      <div className="app-card p-5 md:p-7 mb-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 text-xs sm:text-sm text-slate-500 hover:text-slate-700 mb-3"
            >
            ...
            <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold text-slate-900">Create New Report</h1>
          ...
          <div className="rounded-xl border border-teal-200 bg-teal-50 px-4 py-3 text-xs sm:text-sm text-teal-800 w-full md:w-auto">
